...
export default function Header() {
  ...
  React.useEffect(() => {
    if (pathName === '/') setActiveButton(homeButton);
    if (pathName === '/projects') setActiveButton(projectsButton);
    if (pathName === '/contact') setActiveButton(contactButton);
  }, [pathName]);
        ...
        <div className={styles.navbar}>
          ...
          <nav>
            <div className={styles.navLinks}>
              <Link href="/" ref={homeButton} className={activeButton === homeButton ? styles.active : undefined}>
                Home
              </Link>
              ...
              <Link
                href="/projects"
                ref={projectsButton}
                className={activeButton === projectsButton ? styles.active : undefined}
              >
                Projects
              </Link>
              ...
              <Link
                href="/contact"
                ref={contactButton}
                className={activeButton === contactButton ? styles.active : undefined}
              >
                Contact
              </Link>
            </div>
